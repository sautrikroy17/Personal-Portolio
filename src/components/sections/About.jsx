    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 flex-1 flex flex-col justify-center">
        ...
        >
          ...
          <div>
            <div className="group inline-flex items-center gap-2.5 cursor-default transition-all duration-300">
              <span className="text-xs sm:text-sm font-mono font-bold tracking-widest text-sky-400 drop-shadow-[0_0_6px_rgba(56,189,248,0.4)] group-hover:text-sky-300 group-hover:drop-shadow-[0_0_14px_rgba(56,189,248,0.9)] transition-all duration-300">
                01
              </span>
              <span className="text-xs sm:text-sm font-mono font-medium tracking-widest text-zinc-600 group-hover:text-zinc-400 transition-colors duration-300">
                /
              </span>
              <span className="text-xs sm:text-sm font-mono font-bold tracking-widest text-white uppercase group-hover:text-white group-hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.7)] transition-all duration-300">
                ABOUT
              </span>
